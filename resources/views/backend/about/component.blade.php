        ...
        <div class="container-fluid">
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <span>Development component</span>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard')}}">Dashboard</a></li>
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">component</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Development component</h4>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <form id="delete-form-{{$item->id}}"
                                                          action="{{ route('component.destroy',$item->id) }}"
                            ...
                            <form action="{{ route('component.store')}}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="componentTitle">Components Title<span class="req">*</span>
                                                </label>
                                                <textarea class="form-control" id="componentTitle" name="componentTitle"
                                                          placeholder="Title">
                                                </textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="componentDescription">Components Description<span
                                                        class="req">*</span> </label>
                                                <textarea class="form-control" id="componentDescription"
                                                          name="componentDescription" placeholder="Description">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="editModal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="{{ route('component.update','1')}}" method="POST">
                                @csrf
                                @method("PUT")
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit Development Components</h5>
                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="editComponentTitle">Components Title <span
                                                        class="req">*</span>
                                                </label>
                                                <textarea class="form-control" id="editComponentTitle"
                                                          name="editComponentTitle"
                                                          value="{{old('title', empty($errors->category_name) ? '' : $errors->title)}}"
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="componentDescription">Components Title <span
                                                        class="req">*</span>
                                                </label>
...
@push('onpage-js')
    <script>
        ...
        $(document).on('click', '.edit_row', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/component') }}/" + row_id + "/edit",
                dataType: "json",
