            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Project Activities</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Project Activities</h4>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <form id="delete-form-{{$item->id}}"
                                                          action="{{ route('activity.destroy',$item->id) }}"
                        ...
                        <div class="modal-content">
                            <form action="{{ route('activity.store')}}" method="POST"
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title">Add New Project Activities</h5>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="activityTitle">Project Title<span
                                                        class="req">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="activityTitle"
                                                       name="activityTitle" placeholder="Project Title">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="activityProject">Project Activities<span
                                                        class="req">*</span>
                                                </label>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="{{ route('activity.update','1')}}" method="POST"
                                ...
                                @method("PUT")
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit Project Activities </h5>
                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="activityEditTitle">Project Title<span
                                                        class="req">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="activityEditTitle"
                                                       name="activityEditTitle" placeholder="Project Title">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="activityEditProject">Project Activities<span
                                                        class="req">*</span>
                                                </label>
                                                <textarea class="form-control"
                                                          id="activityEditProject"
                                                          name="activityEditProject">
                                                </textarea>
                                                <textarea class="form-control"
                                                          id="oldActivityEditProject"
                                                          name="oldActivityEditProject" hidden>
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
...
@push('onpage-js')
    <script>
        ...
        $(document).on('click', '.edit_row', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/activity') }}/" + row_id +
                    "/edit",
                dataType: "json",
                success: function (response) {
                    var r_val = response.row_data;
                    $('#row_id').val(r_val.id);
                    $('#activityEditTitle').val(r_val.title);
                    $('#activityEditProject').val(r_val.description);
                    $('#oldActivityEditProject').val(r_val.description);
        ...
        CKEDITOR.replace('activityProject');
        CKEDITOR.replace('activityEditProject');
    </script>
@endpush
