                                        ...
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="productTitle"
                                                       name="productTitle" placeholder="Product Title">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                            ...
                            <form action="{{ route('product.update','1')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="editProductDescription">Product Description<span
                                                        class="req">*</span>
                                                </label>
                                                <textarea class="form-control" id="editProductDescription"
                                                          name="editProductDescription" placeholder="Product Description">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
...
@push('onpage-js')
    <script>
        ...
        $(document).on('click', '.edit_row', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/product') }}/" + row_id + "/edit",
                dataType: "json",
                success: function (response) {
                    var r_val = response.row_data;
                    $('#row_id').val(r_val.id);
                    $('#editProductTitle').val(r_val.title);
                    $('#editProductDescription').val(r_val.description);
