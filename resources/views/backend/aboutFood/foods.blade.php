        ...
        <div class="container-fluid">
            ...
            <div class="row">
                            ...
                            <form action="{{ route('foods.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="foodsTitle">Foods Title<span class="req">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="foodsTitle"
                                                       name="foodsTitle" placeholder="Foods Title">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="foodsDescription">Description<span
                                                        class="req">*</span>
                                                </label>
                                                <textarea class="form-control" id="foodsDescription"
                                                          name="foodsDescription" placeholder="Foods Description">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="modal fade" id="editModal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="{{ route('foods.update','1')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                <div class="modal-header">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="editFoodsTitle">Foods Title <span
                                                        class="req">*</span>
                                                </label>
                                                <input type="text" class="form-control" id="editFoodsTitle"
                                                       name="editFoodsTitle"
                                                       value="{{old('title', empty($errors->title) ? '' : $errors->title)}}"
                                                       placeholder="Foods Title">
                                                @if ($errors->has('title'))
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="editFoodsDescription">Food Description<span
                                                        class="req">*</span>
                                                </label>
                                                <textarea class="form-control" id="editFoodsDescription"
                                                          name="editFoodsDescription">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
...
@push('onpage-js')
    <script>
        ...
        $(document).on('click', '.edit_row', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/foods') }}/" + row_id + "/edit",
                dataType: "json",
                success: function (response) {
                    var r_val = response.row_data;
                    console.log(r_val);
                    $('#row_id').val(r_val.id);
                    $('#editFoodsTitle').val(r_val.title);
                    $('#editFoodsDescription').val(r_val.description);
        ...
        // CKEDITOR.replace('editFoodsCookingSteps');
        // CKEDITOR.replace('editFoodsDescription');
        // CKEDITOR.replace('foodsDescription');
        // CKEDITOR.replace('foodsCooking');
    </script>
@endpush
