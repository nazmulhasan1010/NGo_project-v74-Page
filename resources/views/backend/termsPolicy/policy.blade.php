            ...
            <div class="row page-titles mx-0">
                ...
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Privacy</a></li>
                    </ol>
                </div>
            </div>
            <!-- row -->
                            ...
                            <div class="table-responsive">
                                <table id="example3" class="display" style="min-width: 845px">
                                    ...
                                    @foreach ($privacy as $key=>$item)
                                        @php
                                            if (strlen($item->privacy)>100){
                                               $privacy = substr($item->privacy,0,100);
                                            }else{
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <form id="delete-form-{{$item->id}}"
                                                          action="{{ route('privacy.destroy',$item->id)}}"
                        ...
                        <div class="modal-content">
                            <form action="{{ route('privacy.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title">Add New Privacy</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                <label for="privacy">Privacy Policy<span
                                                        class="req">*</span>
                                                </label>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form action="{{ route('privacy.update',1)}}" method="POST"
                                ...
                                @method("PUT")
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit Privacy</h5>
                                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12">
                                            <div class="form-group">
                                                ...
                                                <label for="editPrivacy">Privacy Policy<span
                                                        class="req">*</span>
                                                </label>
                                                <textarea class="form-control"
                                                          id="editPrivacy"
...
@push('onpage-js')
    <script>
        ...
        $(document).on('click', '.edit_row', function (e) {
            ...
            $.ajax({
                type: "get",
                url: "{{ url('admin/privacy') }}/" + row_id + "/edit",
                dataType: "json",
