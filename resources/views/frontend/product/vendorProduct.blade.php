...
@section('content')
    ...
    @php
        if (App::isLocale('bn')) {
            $vendorTitle = $vendorName->owner_company;
        }else{
            $vendorTitle = $vendorName->owner_company;
        }
    @endphp
            ...
            <div class="container">
                <div class="archive-header">
                    <div class="row align-items-center">
                        <div class="col-xl-3">
                            <h1 class="mb-15" style="text-transform: capitalize; font-size:30px">{{$vendorTitle}}</h1>
                            <div class="breadcrumb">
                                <a href="{{url('/')}}" rel="nofollow"><i class="fi-rs-home mr-5"></i>{{__('front.home')}}</a>
                                <span></span> {{__('front.product')}} <span></span> {{$vendorTitle}}
                            </div>
                        </div>
                    ...
                    <div class="row product-grid">
                        @foreach($products as $product)
                            ...
                            @php
                                ...
                                $categoryName = getCategories($product->category, 'spe')[0];
                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                    ...
                                    <div class="product-content-wrap">
                                        <div class="product-category">
                                            <a href="{{route('products',['catName'=>$categoryName->title,'catId'=>encrypt($categoryName->id)])}}">{{$categoryName->title}}</a>
                                        </div>
                                        <h2>
